...
// @Router /api/submitcargoorder [post]
...
// @Param request body map[string]string true "Order status (completed/rejected)"
// @Success 200 {object} map[string]string "Order completed successfully"
// @Failure 400 {object} map[string]string "Invalid request"
// @Failure 401 {object} map[string]string "Unauthorized"
// @Failure 403 {object} map[string]string "Forbidden"
