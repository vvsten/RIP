...
export default defineConfig({
  ...
  base: process.env.VITE_BASE_URL || (process.env.NODE_ENV === 'production' ? '/RIP-2-mod-transport_logistic/' : '/'),
  plugins: [
    react(),
    VitePWA({
      ...
      manifest: {
        ...
        scope: process.env.VITE_BASE_URL || (process.env.NODE_ENV === 'production' ? '/RIP-2-mod-transport_logistic/' : '/'),
        start_url: process.env.VITE_BASE_URL || (process.env.NODE_ENV === 'production' ? '/RIP-2-mod-transport_logistic/' : '/'),
        icons: [
          {
            src: 'pwa-192x192.png',
            sizes: '192x192',
