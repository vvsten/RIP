...
// TableName sets the custom table name for logistics requests.
...
// TableName sets the custom table name for the request-services bridge table.
func (OrderService) TableName() string {
	return "LogisticRequestService"
}
